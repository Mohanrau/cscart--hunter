<div id="content_yml">
    ...
    <div id="acc_general" class="collapse in">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="product_data[yml2_manufacturer_warranty]" id="yml2_manufacturer_warranty" size="55" value="{$product_data.yml2_manufacturer_warranty}" class="input-text-large" />
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="product_data[yml2_seller_warranty]" id="yml2_seller_warranty" size="55" value="{$product_data.yml2_seller_warranty}" class="input-text-large" />
            </div>
        </div>
